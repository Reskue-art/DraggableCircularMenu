...
function createSvgIcon(path, displayName) {
  function Component(props, ref) {
    return /*#__PURE__*/jsxRuntime.jsx(SvgIcon, _extends$1({
...
var DraggableCircularMenu = function (_a) {
    ...
    var _d = React.useState(0.75), valueProgress = _d[0]; _d[1];
    var _e = React.useState(0), selectedCurrencyIndex = _e[0], setSelectedCurrencyIndex = _e[1];
    var _f = useDraggable({
    ...
    return (React.createElement(Box$1, { component: "div" },
        React.createElement(RadialProgressBar, null,
            React.createElement(RPBHalf1, null),
            ...
            React.createElement(Circle, null,
                React.createElement(BoxDraggable, { ref: draggbleRef, style: {
                        transform: "translate(".concat(dx, "px, ").concat(dy, "px)"),
                        zIndex: 9999,
                    } }),
                React.createElement(TypographyStyled, { variant: "subtitle1" },
                    ...
                    "Min. Salary"))),
        React.createElement(Box$1, { component: "div", display: "flex", justifyContent: "center", alignItems: "center", gap: 2, mt: 5 }, currencies.map(function (currency, index) { return (React.createElement(ChipStyled, { key: index, label: currency.label, variant: "filled", sx: {
