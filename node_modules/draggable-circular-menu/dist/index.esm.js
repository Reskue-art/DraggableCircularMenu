...
function createBox(options = {}) {
  ...
  const Box = /*#__PURE__*/React.forwardRef(function Box(inProps, ref) {
    ...
    const _extendSxProp = extendSxProp(inProps),
      ...
      other = _objectWithoutPropertiesLoose(_extendSxProp, _excluded$a);
...
function createSvgIcon(path, displayName) {
  function Component(props, ref) {
    return /*#__PURE__*/jsx(SvgIcon, _extends$1({
...
var DraggableCircularMenu = function (_a) {
    _a.values; _a.colors; _a.textColor; _a.options;
    var _d = React__default.useState(0.75), valueProgress = _d[0]; _d[1];
    var _e = React__default.useState(0), selectedCurrencyIndex = _e[0], setSelectedCurrencyIndex = _e[1];
    var _f = useDraggable({
        initialAngle: valueProgress,
    }), draggbleRef = _f[0], dx = _f[1], dy = _f[2], angle = _f[3];
    // Render
    //--------------------------------------------------------------------------
    return (React__default.createElement(Box$1, { component: "div" },
        React__default.createElement(RadialProgressBar, null,
            React__default.createElement(RPBHalf1, null),
            React__default.createElement(RPBHalf2, { style: {
                    background: angle > 0.5 ? "#00FBDF" : "inherit",
            ...
            React__default.createElement(Circle, null,
                React__default.createElement(BoxDraggable, { ref: draggbleRef, style: {
                        transform: "translate(".concat(dx, "px, ").concat(dy, "px)"),
                        zIndex: 9999,
                    } }),
                React__default.createElement(TypographyStyled, { variant: "subtitle1" },
                    React__default.createElement("span", { style: { fontSize: "2.5rem" } },
                        currencies[selectedCurrencyIndex].sign,
                        data[Math.round(angle * (data.length - 1))],
                        ".00"),
                    React__default.createElement("br", null),
                    "Min. Salary"))),
        React__default.createElement(Box$1, { component: "div", display: "flex", justifyContent: "center", alignItems: "center", gap: 2, mt: 5 }, currencies.map(function (currency, index) { return (React__default.createElement(ChipStyled, { key: index, label: currency.label, variant: "filled", sx: {
                background: index === selectedCurrencyIndex ? "#00FBDF" : "#D9D9D9",
            }, onClick: function () { return setSelectedCurrencyIndex(index); } })); }))));
};
