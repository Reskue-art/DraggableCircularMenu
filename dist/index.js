...
var useDraggable = function (_a) {
    ...
    var _b = React.useState(), node = _b[0], setNode = _b[1];
    var _c = React.useState(initialAngle), angle = _c[0], setAngle = _c[1];
...
var DraggableCircularMenu = function (_a) {
    ...
    // options = [],
    text = _e === void 0 ? "" : _e;
    var _f = React.useState(0.75), valueProgress = _f[0]; _f[1];
    ...
    // Render
    //--------------------------------------------------------------------------
    return (React.createElement(Box$1, { component: "div" },
        React.createElement(RadialProgressBar, null,
            React.createElement(RPBHalf1, { circleColor: circleColor }),
            React.createElement(RPBHalf2, { style: {
            ...
            React.createElement(Circle, null,
                React.createElement(BoxDraggable, { circleColor: circleColor, ref: draggbleRef, style: {
                        transform: "translate(".concat(dx, "px, ").concat(dy, "px)"),
                        zIndex: 9999,
                    } }),
                React.createElement(TypographyStyled, { sx: { color: textColor } },
...
module.exports = DraggableCircularMenu;
